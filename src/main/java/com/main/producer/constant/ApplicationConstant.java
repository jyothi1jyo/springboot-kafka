package com.main.producer.constant;

 public class ApplicationConstant {
 //public static final String KAFKA_LOCAL_SERVER_CONFIG = "localhost:9092";
 public static final String KAFKA_LOCAL_SERVER_CONFIG = "kafka:9092";
 public static final String GROUP_ID_STRING = "group-id-string-1";
 public static final String TOPIC_NAME = "profiles_information";
